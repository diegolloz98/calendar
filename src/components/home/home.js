                ...
                if(bool){
                    ...
                    days.push(
                        ...
                        > 
                            ...
                            <icon onClick={() => { deleteEvent(event)}}> <AiOutlineCloseCircle/> </icon>
                        </td>
                    )
        ...
        <div>    
             <div class="container">
                <table>
                    <thead> 
                        <div>
                            <button className='btn' onClick={() => {setDate(new Date(date.getFullYear(), date.getMonth()-1, date.getDate()))}}>Prev</button>
                            <button className='btn btn-primary' onClick={() => {setDate(new Date(date.getFullYear(), date.getMonth()+1, date.getDate()))}}>Next</button>
                            <tr>
